            ...
            <div className='col-sm-8 article-main-content'>
              <div className='article-main-left-content'>
                ...
                <div className='articleContent-body'>
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 2: Minimalist Elegance'>
                      <strong>Mẫu 2: Urban Jungle</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 3: Minimalist Elegance'>
                      <strong>Mẫu 3: Boho Chic</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 4: Minimalist Elegance'>
                      <strong>Mẫu 4: Industrial Loft</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 5: Minimalist Elegance'>
                      <strong>Mẫu 5: Scandinavian Simplicity</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 6: Minimalist Elegance'>
                      <strong>Mẫu 6: Mid-Century Modern</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 7: Minimalist Elegance'>
                      <strong>Mẫu 7: Luxury Glam</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 8: Minimalist Elegance'>
                      <strong>Mẫu 8: Coastal Vibes</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 9: Minimalist Elegance'>
                      <strong>Mẫu 9: Rustic Modern</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
                  ...
                  <div className='articleContent-body-item'>
                    <p className='articleText' id='Mẫu 10: Minimalist Elegance'>
                      <strong>Mẫu 10: Art Deco Revival</strong>
                    </p>
                    <img
                      src='assets\articleIMG\IDA1.jpeg'
